...
## Project Structure
    ...
    ├── testapiautodatamod_106921  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_106921`
...
2. Clone this repo and `cd testapiautodatamod_106921`
